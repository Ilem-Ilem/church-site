...
Route::prefix('admin/dashboard')->middleware(['auth', 'admin'])->group(function () {
    ...
    //              FUNCTIONS SECTION
    //-------------------------------------------------------------------
    Volt::route('functions', 'admin.dashboard.functions.index')->name('admin.dashboard.functions.index');
    Volt::route('functions/assign-function', 'admin.dashboard.functions.assign-function')->name('admin.dashboard.functions.assign-general-function');
    // Volt::route('functions/general-function', 'admin.dashboard.functions.general-function')->name('admin.dashboard.functions.general-function');
    Volt::route('functions/create', 'admin.dashboard.functions.create-function')->name('admin.dashboard.functions.create-function');
    ...
    // Appointments Routes
    Volt::route('appointments', 'admin.dashboard.appointments')->name('admin.dashboard.appointments');
    Volt::route('appointments/index', 'admin.dashboard.appointments.index')->name('admin.dashboard.appointments.index');
    Volt::route('appointments/reschedule', 'admin.dashboard.appointments.reschedule')->name('admin.dashboard.appointments.reschedule');
